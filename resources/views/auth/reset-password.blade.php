                    ...
                    <div class=" main-content-area">
                        <div class="wrap-login-item ">                      
                            <div class="login-form form-item form-stl">
                                ...
                                <x.x-jet-validation-errors class="mb-4"/>
                                <form name="frm-login" method="POST" action="{{route('password.update')}}">
                                    ...
                                    <fieldset class="wrap-input item-width-in-half ">
                                        ...
                                        <input type="password" id="password_conformation" name="password-conformation" placeholder="Confirm Password" required autocomplete="new-password">
                                    </fieldset>                               
