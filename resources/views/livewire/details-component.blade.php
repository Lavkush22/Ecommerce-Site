            ...
            <div class="row">
                        ...
                        <div class="detail-info">
                            <div class="product-rating">
                                ...
                                @foreach($product->orderItems->where('rstatus',1) as $orderItem)
                                  @php
                                    $avgrating = $avgrating + $orderItem->review->rathig;
                                  @endphp
                                @endforeach
                                @for($i=1;$i<=5;$i++)
                                    @if($i<=$avgrating)
                            ...
                            <div class="wrap-price"><span class="product-price">{{$product->sale_pricee}}</span></div>
                            @else
                             <div class="wrap-price"><span class="product-price">{{$product->regular_pricee}}</span></div>
                             @endif
                            ...
                            <div class="wrap-butons">
                                @if($product->sale_pricee>0 && $sale->status==1 && $sale->sale_date >Carbon\Carbon::now())
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->sale_pricee}})">Add to Cart</a>
                                @else
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->regular_pricee}})">Add to Cart</a>
                                @endif
                                <div class="wrap-btn">
                                                    ...
                                                    <div id="comment-20" class="comment_container"> 
                                                        ...
                                                        <div class="comment-text">
                                                            <div class="star-rating">
                                                                <span class="width-{{$orderItem->review->rathig * 20}}-percent">Rated <strong class="rating">{{$orderItem->review->rathig}}</strong> out of 5</span>
                                                            </div>
                                                            <p class="meta"> 
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                    ...
                    <div class="widget mercado-widget widget-product">
                        ...
                        <div class="widget-content">
                            <ul class="products">
                                @foreach($populor_products as $p_product)
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">{{$p_product->regular_pricee}}</span></div>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
                            ...
                            <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">{{$r_product->regular_pricee}}</span>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
