                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            <div class="contact-box contact-form">
                                ...
                                <form  name="frm-contact" wire:submit.prevent="sendMessage">
                                    ...
                                    <input type="text" value="" id="email" name="email" wire:model="email"> @error('email')<p class="text-danger">{{$message}}</p>@enderror

                                    <label for="phone">Number Phone</label>
                                    <input type="text" value="" id="phone" name="phone" wire:model="phone" > @error('phone')<p class="text-danger">{{$message}}</p>@enderror
