            ...
            <div class=" main-content-area">
                    ...
                    <ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
                            <div class="product-image">
                                <figure><img src="{{asset('assets/images/products')}}/{{$item->model->image}}" alt="{{$item->image}}"></figure>
                            </div>
                            <div class="product-name">
                                <a class="link-to-product" href="{{route('product.details',['slug'=>$item->model->slug])}}">{{$item->model->name}}</a>
                            </div>
                            <div class="price-field produtc-price"><p class="price">${{$item->model->regular_pricee}}</p></div>
                            <div class="quantity">
                                <div class="quantity-input">
                                    <input type="text" name="product-quatity" value="{{$item->qty}}" data-max="120" pattern="[0-9]*" >                                   
                                    <a class="btn btn-increase" href="#" wire:click.prevent="inquant('{{$item->rowId}}')"></a>
                                    <a class="btn btn-reduce" href="#" wire:click.prevent="dequant('{{$item->rowId}}')"></a>
                                </div>
                ...
                <div class="summary">
                    <div class="order-summary">
                       ...
                       <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i> </a> </span><b class="index">-${{number_format($discount)}}</b></p>
                ...
                <div class="text-center" style="padding:30px 0;">
                    ...
                    <a href="/shop" class="btn btn-success">Shop No</a>
                </div>
                    ...
                    <ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="quantity">
                                ...
                                <p class="text-center"><a href="#" wire:click.prevent="moveToCard('{{$item->rowId}}')">Move To Cart</a></p>
                            </div>
                            <div class="delete">
                                <a href="#" wire:click.prevent="deleteFromSaveForLater('{{$item->rowId}}')" class="btn btn-delete" title="">
                                    ...
                                    <i class="fa fa-times-circle" aria-hidden="true" style="color :red;">Delete</i>
                                </a>
                            </div>
                        </li>
                        @endforeach                                             
